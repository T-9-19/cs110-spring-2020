...
class HeyThatsMyFish:
    ...
    def is_valid_move(self, tile):
        ...
        # detect if penguins between selected tile and target tile from left to right
        # TODO: Check right to left, and for empty tiles
        if current_row == target_row:
            for col in range(current_col + 2, target_col + 2, 2):
                if self._tiles[current_row][col].has_penguin():
                    return False

        #TODO: Check along diagonals
        return True
